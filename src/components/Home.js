                ...
                <div className='john-doe'>
                  <div className='profile-info'>
                    <div className='banner_image'>
                      <img src="/images/banner-john.jpg" alt='John' />
                    </div>
                  ...
                  <p className='banner-content-second'>Lorem ipsum dolor shit amet...</p>
                </div>
                <div className='right_cart'>
                  <h5>$10.00</h5>
                  <ul>
                    <li><i class="fa fa-solid fa-cart-plus"></i></li>
                  </ul>
                </div>
              </div>
            </div>
...
<div className='inner-border last-border'>
<div className='inner-health'>
<div className='health-icon'>
